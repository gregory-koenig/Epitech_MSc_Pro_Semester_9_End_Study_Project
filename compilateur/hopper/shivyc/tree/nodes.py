...
class IfStatement(Node):
    ...
    def __str__(self) -> str:
        return f'IF,STARTCOND,{self.cond},ENDCOND,IFBODYSTART,{self.stat}' + (f',IFBODYEND,IFELSESTART,{self.else_stat},IFELSEEND' if self.else_stat != None else '')
...
class ForStatement(Node):
    ...
    def __str__(self) -> str:
        return f'FOR,BEGINFORPARAMS,{self.first},{self.second},{self.third},ENDFORPARAMS,'
...
class Declaration(Node):
    ...
    def __str__(self) -> str:
        if self.body:    
            return f'DECLARATION,{str(self.node)},BEGINDECLBODY,{self.body}ENDDECLBODY,'
        return f'DECLARATION,BEGINDECLINIT,{str(self.node)},ENDDECLINIT,BEGINDECLBODY,ENDDECLBODY,'
